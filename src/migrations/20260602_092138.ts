...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_news_category" AS ENUM('competition', 'blog', 'announcement');
  CREATE TYPE "public"."enum_pricing_period" AS ENUM('month', 'quarter', 'once');
  ...
  CREATE TABLE "teachers_certifications" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"cert" varchar
  ...
  ALTER TABLE "teachers_certifications" ADD CONSTRAINT "teachers_certifications_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."teachers"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "teachers_certifications_order_idx" ON "teachers_certifications" USING btree ("_order");
  CREATE INDEX "teachers_certifications_parent_id_idx" ON "teachers_certifications" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "teachers_certifications" CASCADE;
  ...
  DROP TYPE "public"."enum_pricing_period";`)
}
